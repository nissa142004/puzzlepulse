    ...
    return (
        <div className="mission-complete animate-fade" style={{ background: 'rgba(0,255,100,0.1)' }}>
            <div className="glass-panel" style={{ padding: '3rem', borderTop: '4px solid #00ff00', textAlign: 'center', background: 'rgba(0,0,0,0.8)' }}>
                <h2 className="glow-text" style={{ color: '#00ff00', fontSize: '3.5rem', marginBottom: '1rem' }}>LEVEL COMPLETE</h2>
                <p style={{ color: 'var(--text-dim)', fontSize: '1.2rem', marginBottom: '2rem' }}>You have successfully completed all stages in this level.</p>
                ...
                <button className="primary pulse-animation" onClick={() => window.location.reload()}>RETURN TO DASHBOARD</button>
            </div>
        </div>
    );
};
