...
export const getWallsForLevel = (level) => {
    return LEVEL_WALLS[((level - 1) % 4) + 1] || LEVEL_WALLS[1];
};

export const getThemeForMap = (mapId) => {
    return MAP_THEMES[mapId] || MAP_THEMES.map1;
};
